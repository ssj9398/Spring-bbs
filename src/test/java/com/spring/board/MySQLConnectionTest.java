...
public class MySQLConnectionTest {
    ...
    static final String URL = "jdbc:mysql://127.0.0.1:3306/board?useUnicode=true&characterEncoding=utf8&allowPublicKeyRetrieval=true&useSSL=false";
    static final String USERNAME = "alisya";
